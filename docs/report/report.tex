...
\paragraph{Cache pipeline exploiting}
...
reading (as explained in Subsection~\ref{subsec:basic_impl}).
...
\paragraph{\acp{fifo} accesses scheduling}
...
Subsection~\ref{subsec:basic_impl}) it is not possible to achieve such a
